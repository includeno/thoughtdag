...
export async function importProjectFromFile(file: File, pre?: unknown): Promise<boolean> {
  let parsed: { schemaVersion?: number; version?: number; name?: string; nodes?: ThoughtNode[]; edges?: ThoughtEdge[]; events?: unknown[]; instantiatedFrom?: ProjectMeta['instantiatedFrom']; sharedReadonly?: boolean };
  try {
